...
void Pipeline::createPipeline(shaderModule shader){
    ...
    multisampling.rasterizationSamples = *KP::ENGINE::OBJECT_msaa.getPointerMsaaSamples();
...
void Pipeline::createRenderPass() {
    ...
    VkAttachmentReference colorAttachmentRef{}; // CORES FROM VULKAN
    colorAttachmentRef.attachment = 0;
    colorAttachmentRef.layout = VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL;

    VkAttachmentReference depthAttachmentRef{}; // DEPTH
    depthAttachmentRef.attachment = 1;
    depthAttachmentRef.layout = VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL;

    VkAttachmentReference colorAttachmentResolveRef{}; // MSAA
